...
public class NarrowingOrManualConverting {
	...
	long _lNumber=(long)$fNumber;
	int _iNumber=(int)$fNumber;
	short _sNumber=(short)$fNumber;
	byte _bNumber=(byte)$fNumber;
	

	
	System.out.println($fNumber);
	System.out.println(_lNumber);
	System.out.println(_iNumber);
	System.out.println(_sNumber);
